...
namespace GcxEditorGUI
{
    internal class VersionSupport
    {
        ...
        {
            //v0.1.0.0
            GitHubClient gitHubClient = new(new ProductHeaderValue("gcxEditor"));
            IReadOnlyList<Release> releases = gitHubClient.Repository.Release.GetAll("sagefantasma", "gcxEditor").Result;
